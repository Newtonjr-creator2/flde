...
import 'runtime_verification_screen.dart';
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('RealBuzzingIdentifier'),
        actions: [
          IconButton(
            icon: const Icon(Icons.terminal),
            tooltip: 'Terminal',
            onPressed: () => Navigator.push(context, MaterialPageRoute(builder: (_) => const TerminalScreen())),
          ),
          IconButton(
          ...
          IconButton(
            ...
            tooltip: 'Runtime Verification',
            onPressed: () =>
                Navigator.push(context, MaterialPageRoute(builder: (_) => const RuntimeVerificationScreen())),
          ),
        ],
      ),
      body: Center(
